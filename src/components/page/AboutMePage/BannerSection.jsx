      ...
      <div className="flex items-center justify-between">
        <div className="w-1/2 flex flex-col gap-8">
          ...
          <p className="text-gray-100 text-md font-medium">
            I'm a Frontend Developer with less than a year of experience,
            building responsive and accessible web interfaces using Next.js and
            Tailwind CSS. I focus on clean design, performance, and
            developer-friendly architecture.
          </p>
          <div className="flex items-center justify-start gap-2">
            <Button
              className={
                "flex items-center justify-between text-gray-100 bg-[#383838] hover:bg-[#484848] hover:cursor-pointer hover:shadow-2xl"
              }
            >
              <Icon icon={"gg:add"} className="text-gray-100 size-4" />
