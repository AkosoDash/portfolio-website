    ...
    <div className="w-full px-8 py-4 flex flex-col">
      <div className="w-full flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-y-8 justify-start items-start">
          ...
          <div className="w-full flex space-x-4 items-center justify-around">
            <div className="relative size-96 rounded-lg">
              <Image
                ...
                alt="Image"
                objectFit="cover"
                className="rounded-lg p-2 shadow-white/25 shadow-sm"
                fill
              />
            </div>
            <div className="relative size-96 rounded-lg">
